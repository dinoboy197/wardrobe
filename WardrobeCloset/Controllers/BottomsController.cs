...
namespace WardrobeCloset.Controllers
{
    public class BottomsController : Controller
    {
        ...
        {
            var bottoms = db.Bottoms.Include(b => b.Outfit);
        ...
        public ActionResult Create([Bind(Include = "BottomsID,Name,ClothingType,OutfitsID,Brand,Photo,Color,Occasion,Season,Favorite,TimesWorn,Dirty")] Bottom bottom)
        {
            ...
            ViewBag.OutfitsID = new SelectList(db.Outfits, "OutfitsID", "OutfitName", bottom.OutfitsID);
            return View(bottom);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,Name,ClothingType,OutfitsID,Brand,Photo,Color,Occasion,Season,Favorite,TimesWorn,Dirty")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
